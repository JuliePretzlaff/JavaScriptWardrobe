...
specify a season (please us first capital letter: ie Summer or Winter).  Then an alert box pops up identifying all items of that type that
match the user's desired season


****The website MUST allow the user to dynamically enhance size and color of text on mouseover utilizing a JavaScript method, buttons and text fields The text MUST return to its default size and color when a mouseover is not being performed.
if the user mouses over the name of any clothing item (on the index view of top, bottom, accessory, shoes) the name will change size and color.
will return to normal if mouse is removed.

****The website MUST allow the user to navigate to another site utilizing a JavaScript method, buttons and text fields.The website MUST inform the user they are being directed to another site.  The website MUST allow the user to cancel the action before it is perfomed. If the user affirms the action, the website must open in another browser tab.
at the bottom of the home index, there is a button asking if the user wants to see more of my work
on click this will ask the user if they're ok with being directed to a new site.  if so, my portfolio opens in a new tab


****Add a copyright with date in the footer of your website.The website MUST dynamically replace the copyright and date text to "created by "Insert Your Name".You can choose to perform this action onhover or onclick.
the footer has copyright 2018.  when clicked, will change to "Created by Julie" second click will change it back
...
at the bottom of the index page is a form for contacting me.  onfocus and onblur, the input fields are highlighted in color
